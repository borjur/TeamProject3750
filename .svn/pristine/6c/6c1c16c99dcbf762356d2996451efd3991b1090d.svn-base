...
public class QueryServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session.getAttribute("sessionLocations") == null)
        {
        LocationDropdownModel lm = new LocationDropdownModel();
        Map<String,Integer> locations = lm.getLocations();
        
        session.setAttribute("sessionLocations", locations);
        }
